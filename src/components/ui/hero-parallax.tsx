  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 z-10">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
       Empowering Businesses <br /> with Innovative SaaS Solutions
      </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8 relative z-20">
        <Link 
          to="/get-a-quote"
          className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors shadow-lg cursor-pointer inline-block text-center"
        >
          Get Started
        </Link>
        <Link 
          to="/products"
          className="border-2 border-blue-600 text-blue-600 dark:text-blue-400 hover:bg-blue-600 hover:text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors cursor-pointer inline-block text-center"
        >
          Explore Products
        </Link>
      </div>
